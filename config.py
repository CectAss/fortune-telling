...
MAIN_BUTTONS = ["Гадание", "Задать вопрос", "Управление гороскопом", "Информация"]

ADMIN_BUTTONS = ["Тест рассылки", "Тест лимита", "Заменить предсказания", "Актуальные предсказания"]
...
Реквизиты: 8-905-715-28-59 Сбербанк или Т-банк Евгений Юрьевич К.

Желательно после этого перевода написать в личные сообщения группы "Гудтаймс crew" (ссылка на нее находится в разделе "Ссылки").
'''
INFO_CREW_ONFIRE_TEXT = """Здесь вы можете лицезреть фотографии с концертов. 
